...
- Deploy config: `vllm_omni/deploy/breeze_tts.yaml` (auto-loaded by HF `model_type`; `breeze_tts_2.yaml` remains an alias); see [`recipes/BreezeBlue/Breeze-TTS-2.md`](../../../recipes/BreezeBlue/Breeze-TTS-2.md) for the online-serving recipe.
