...
The deploy config at `vllm_omni/deploy/breeze_tts.yaml` auto-loads (async-chunk streaming with 1, 2, 4, then 5-frame inter-stage chunks). The previous `breeze_tts_2.yaml` filename remains an alias.
