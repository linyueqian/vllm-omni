...
class OmniInputProcessor(InputProcessor):
    ...
    def process_inputs(
        ...
        platform_validate_request = getattr(self, "_platform_validate_request", None)
        if platform_validate_request is not None:
            platform_validate_request(processed_inputs, params)
        else:
