...
class VoxCPM2LatentGenerator:
    ...
    def generate_latents(
        ...
        *,
        ...
        # Use _generate_with_prompt_cache with latents_only=True to skip
        # VAE decode in Stage 0; the VoxCPM2ModelForOmni subclass (applied
        # by the native loader) adds this parameter.
        _decode_audio, _target_tok, pred_audio_feat = next(
            inner._generate_with_prompt_cache(
...
class VoxCPM2AudioVAE:
    ...
    def __init__(self, audio_vae: nn.Module, *, patch_size: int = 4):
        ...
        self.sample_rate = int(getattr(audio_vae, "out_sample_rate", getattr(audio_vae, "sample_rate", 48000)))
