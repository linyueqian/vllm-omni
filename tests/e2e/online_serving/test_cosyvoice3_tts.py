...
Covers the default two-stage `cosyvoice3.yaml` deploy config. The
async-chunk streaming variant lives in test_cosyvoice3_tts_async_chunk.py
so each file has a single `OmniServerParams` set and one server lifecycle.
"""
